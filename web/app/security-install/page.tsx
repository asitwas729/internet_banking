...
function IconCert() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth="1.8" style={{ color: '#0D5C47' }}>
    ...
    if (installed) {
      return (
        <button
          ...
          style={{ backgroundColor: '#F0FAF7', color: '#0D5C47', border: '2px solid #5BC9A8' }}>
          <IconCheck />
          설치 완료
        </button>
      )
      ...
      <main className="flex-1 max-w-[900px] mx-auto w-full px-6 py-10 space-y-6">
        ...
        <div className="flex items-center justify-between bg-white rounded-2xl px-8 py-6 shadow-sm" style={{ border: '1px solid #5BC9A820' }}>
          <div className="space-y-2">
            <p className="text-[13px] font-semibold" style={{ color: '#5BC9A8' }}>Security Program</p>
          ...
          <div className="flex-shrink-0 w-20 h-20 rounded-2xl flex items-center justify-center"
            style={{ backgroundColor: '#F0FAF7', border: '1px solid #5BC9A820' }}>
            <svg viewBox="0 0 24 24" fill="none" className="w-9 h-9" stroke="currentColor" strokeWidth="1.5" style={{ color: '#0D5C47' }}>
              <path d="M12 2l7 3v6c0 4.5-3 8-7 9-4-1-7-4.5-7-9V5l7-3z"/>
              <path d="M9 12l2 2 4-4"/>
            </svg>
          </div>
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-sm" style={{ border: '1px solid #5BC9A820' }}>
          <div className="grid grid-cols-2 divide-x" style={{ borderColor: '#E2F5EF' }}>
            ...
            <div className="p-8 space-y-5">
              ...
              <div className="space-y-1.5">
                <p className="text-[13px] text-kb-text-muted">
                  프로그램명: <span className="font-semibold" style={{ color: '#0D5C47' }}>WizIn-Delfino G3</span>
                </p>
              ...
              {checking ? (
                <div className="flex items-center gap-2 px-4 py-3 rounded-lg text-[13px] text-kb-text-muted"
                  ...
                  <svg className="animate-spin w-4 h-4" viewBox="0 0 24 24" fill="none" style={{ color: '#5BC9A8' }}>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Link href="/security-faq" className="py-2 text-[13px] rounded-lg border font-medium hover:bg-[#F0FAF7] transition-colors flex items-center justify-center"
                    style={{ borderColor: '#5BC9A8', color: '#0D5C47' }}>FAQ</Link>
                  <Link href="/security-guide" className="py-2 text-[13px] rounded-lg border font-medium hover:bg-[#F0FAF7] transition-colors flex items-center justify-center"
                    style={{ borderColor: '#5BC9A8', color: '#0D5C47' }}>이용안내</Link>
                </div>
              )}
            </div>
            ...
            <div className="p-8 space-y-5">
              ...
              <div className="space-y-1.5">
                <p className="text-[13px] text-kb-text-muted">
                  프로그램명: <span className="font-semibold" style={{ color: '#0D5C47' }}>AhnLab Safe Transaction</span>
                </p>
                <p className="text-[13px] text-kb-text-body leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <button className="py-2 text-[13px] rounded-lg border font-medium hover:bg-[#F0FAF7] transition-colors"
                  style={{ borderColor: '#5BC9A8', color: '#0D5C47' }}>FAQ</button>
                <button className="py-2 text-[13px] rounded-lg border font-medium hover:bg-[#F0FAF7] transition-colors"
                  style={{ borderColor: '#5BC9A8', color: '#0D5C47' }}>이용안내</button>
              </div>
            </div>
          </div>

          <div className="border-t flex justify-center py-4" style={{ borderColor: '#E2F5EF' }}>
        ...
        <div className="flex justify-center gap-3">
          <button
            ...
            className="px-8 py-2.5 text-[14px] font-semibold rounded-lg border-2 transition-colors hover:bg-[#F0FAF7]"
        ...
        <p className="text-[12px] text-kb-text-muted text-center">
          수동 설치 후에는{' '}
          <span className="underline cursor-pointer" style={{ color: '#0D5C47' }} onClick={() => window.location.reload()}>
            새로고침
          </span>
          {' '}또는 재접속하여 확인하시기 바랍니다.
        </p>
