...
function LogoutContent() {
  ...
  return (
    <div className="min-h-[calc(100vh-260px)] py-12" style={{ backgroundColor: '#F0FAF7' }}>
      <div className="w-full max-w-[540px] mx-auto bg-white rounded-2xl shadow-sm overflow-hidden" style={{ border: '1px solid #5BC9A820' }}>
        ...
        <div className="flex flex-col items-center px-12 py-14 gap-5">
          {/* 아이콘 */}
          <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ backgroundColor: '#F0FAF7' }}>
            {isManual ? (
              <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8" stroke="currentColor" strokeWidth="1.8" style={{ color: '#0D5C47' }}>
          ...
          <p className="text-[14px] text-kb-text-body text-center leading-relaxed">
            {isManual ? (
              <>
                ...
                즐거운 하루 보내시기 바랍니다.<br />
                <span style={{ color: '#0D5C47' }}>확인을 누르시면 메인화면으로 이동합니다.</span>
              </>
            ) : (
              <>
        ...
        {/* AXful 인증서 배너 */}
        <div className="border-t mx-6 mb-6" style={{ borderColor: '#E2F5EF' }} />
        <div className="mx-6 mb-6 flex items-center gap-4 rounded-xl p-5" style={{ backgroundColor: '#F0FAF7', border: '1px solid #5BC9A820' }}>
          ...
          <div>
            ...
            <Link href="/cert" className="text-[13px] hover:underline" style={{ color: '#0D5C47' }}>
              AXful Bank인증서 알아보기 ›
            </Link>
          </div>
        </div>
