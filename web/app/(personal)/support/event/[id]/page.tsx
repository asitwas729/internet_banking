  ...
  'ai-portfolio-launch': {
    ...
    body: (
      <div className="space-y-6 text-[15px] text-kb-text-body leading-relaxed">
        ...
        <div className="rounded-2xl p-6 space-y-4" style={{ backgroundColor: '#F0FAF7', border: '1px solid #5BC9A830' }}>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <span className="w-6 h-6 rounded-full flex items-center justify-center text-white text-[12px] font-bold flex-shrink-0 mt-0.5"
                style={{ backgroundColor: '#0D5C47' }}>1</span>
              <div>
                <p className="font-semibold text-kb-text">AI 추천 정기예금 가입 시 금리 우대</p>
                <p className="text-[14px] text-kb-text-muted mt-0.5">AI 포트폴리오 서비스를 통해 추천받은 정기예금 가입 시 <strong style={{ color: '#0D5C47' }}>연 0.3%p 추가 금리</strong> 제공</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="w-6 h-6 rounded-full flex items-center justify-center text-white text-[12px] font-bold flex-shrink-0 mt-0.5"
                style={{ backgroundColor: '#0D5C47' }}>2</span>
              <div>
                <p className="font-semibold text-kb-text">AI 포트폴리오 분석 리포트 무료 제공</p>
                <p className="text-[14px] text-kb-text-muted mt-0.5">이벤트 기간 중 가입 고객 전원에게 <strong style={{ color: '#0D5C47' }}>월 1회 프리미엄 AI 분석 리포트</strong> 무료 발송</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="w-6 h-6 rounded-full flex items-center justify-center text-white text-[12px] font-bold flex-shrink-0 mt-0.5"
                style={{ backgroundColor: '#0D5C47' }}>3</span>
              <div>
                <p className="font-semibold text-kb-text">추천인 이벤트</p>
                <p className="text-[14px] text-kb-text-muted mt-0.5">친구 추천 가입 시 추천인·피추천인 모두 <strong style={{ color: '#0D5C47' }}>AX 포인트 5,000점</strong> 적립</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <ol className="space-y-2 pl-4">
            <li className="flex gap-2"><span className="font-bold text-[#0D5C47]">1.</span> AXful Bank 인터넷뱅킹 로그인</li>
            <li className="flex gap-2"><span className="font-bold text-[#0D5C47]">2.</span> 금융상품 → AI 포트폴리오 추천 서비스 접속</li>
            <li className="flex gap-2"><span className="font-bold text-[#0D5C47]">3.</span> AI 추천 결과 확인 후 원하는 상품 가입</li>
          </ol>
        </div>
    ...
    body: (
      <div className="space-y-6 text-[15px] text-kb-text-body leading-relaxed">
              ...
              <div key={i} className="flex items-start gap-3 bg-white rounded-xl p-4" style={{ border: '1px solid #5BC9A820' }}>
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-[13px] font-bold" style={{ color: '#0D5C47' }}>{item.reward}</span>
                  </div>
        ...
        <div>
          ...
          <p>4가지 미션 모두 완료 시 <strong style={{ color: '#0D5C47' }}>AXful 스타벅스 아메리카노 e-쿠폰</strong> 추가 증정 (선착순 5,000명)</p>
        </div>
      ...
      <div className="max-w-[860px] mx-auto px-8 py-12">
        ...
        <div className="mb-8 pb-6" style={{ borderBottom: '2px solid #5BC9A8' }}>
          <span className="inline-block px-3 py-1 text-[12px] font-bold rounded-full mb-3"
            style={{ backgroundColor: '#5BC9A820', color: '#0D5C47' }}>
            이벤트
          </span>
